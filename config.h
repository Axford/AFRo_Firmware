...
*/
#define	STEPS_PER_M_X					256000   // 0..102.4mm x 256 = 26214 steps in full range
#define	STEPS_PER_M_Y					256000
#define	STEPS_PER_M_Z					1031000
...
#define MAX_JERK_Z 10
#define MAX_JERK_E 10
...
/*
	This is for the RAMPS v1.4 board configured for AFRo
*/
...
#define	Z_STEP_PIN  					DIO36
#define	Z_DIR_PIN   					DIO34
#define	Z_INVERT_DIR
#define	Z_MIN_PIN   					DIO3
//#define	Z_MAX_PIN   					DIO19
#define Z_ENABLE_PIN          DIO30
#define	Z_INVERT_MIN
//#define	Z_INVERT_MAX
